    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <header className="relative py-24 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <span className="inline-block px-4 py-1 bg-rose-100 text-rose-600 rounded-full text-sm font-medium mb-6">
              Your Personal Wedding Assistant
            </span>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif text-gray-800 mb-6 leading-tight">
            ...
            {!user && !isLoading && (
              <div className="flex flex-col sm:flex-row items-start gap-4">
                <Link
                  href="/register"
                  className="px-8 py-4 bg-gradient-to-r from-rose-500 to-rose-600 text-white rounded-full font-medium hover:from-rose-600 hover:to-rose-700 transition-all shadow-lg hover:shadow-xl"
                >
                  Get Started - $49
                </Link>
                <Link
                  href="/pricing"
                  className="px-8 py-4 text-gray-600 hover:text-gray-800 font-medium"
                >
                  View Pricing
                </Link>
              </div>
            ...
            {user && (
              <Link
                href="/dashboard"
                className="inline-block px-8 py-4 bg-gradient-to-r from-rose-500 to-rose-600 text-white rounded-full font-medium hover:from-rose-600 hover:to-rose-700 transition-all shadow-lg hover:shadow-xl"
              >
                Go to Dashboard
              </Link>
            )}
      ...
      <section className="py-8 px-4 bg-gray-50 border-y border-gray-100">
        <div className="max-w-4xl mx-auto flex flex-wrap items-center justify-center gap-8 text-gray-600 text-sm">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 text-sm">
                Get a unique chat link. Add it to your wedding website, invitations, or text it directly to guests.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <p className="text-gray-600">
                Stop answering the same questions about hotels, dress code, and directions
                over and over. Let your concierge handle it.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <p className="text-gray-600">
                Guests can get answers at midnight without texting you.
                The chat works around the clock, even when you're sleeping.
              </p>
            </div>
          </div>
        </div>
      ...
      {!user && !isLoading && (
        <section className="py-20 px-4 bg-gradient-to-r from-rose-500 to-rose-600">
          <div className="max-w-2xl mx-auto text-center text-white">
            ...
            <Link
              href="/register"
              className="inline-block px-8 py-4 bg-white text-rose-600 rounded-full font-medium hover:bg-rose-50 transition-colors shadow-lg"
            >
              Get Started Now
            </Link>
          </div>
